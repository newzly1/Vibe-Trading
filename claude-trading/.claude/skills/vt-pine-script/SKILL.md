...
1. the **vt-pine-script** skill — read this guide
2. `Read("config.json")` — understand instruments, dates, parameters
3. `Read("code/signal_engine.py")` — understand the Python strategy logic
4. **Translate** the strategy to ALL platforms using the references below
5. `Write("artifacts/strategy.pine")` — save the combined output
...
3. `Write("artifacts/strategy.pine")` — save the combined output
