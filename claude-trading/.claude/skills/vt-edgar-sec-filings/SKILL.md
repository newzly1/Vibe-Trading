...
This skill provides the analytical framework for interpreting SEC filings. Data retrieval uses `WebFetch` tool with EDGAR URLs or `yfinance` Ticker objects for structured financial data.
